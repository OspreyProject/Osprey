...
(() => {
    ...
    const staticKeys = {
        ...
        TOAST_SETTINGS_IMPORTED: 'toastSettingsImported',
        TOAST_SETTINGS_EXPORTED: 'toastSettingsExported',
        TOAST_IMPORT_INVALID: 'toastImportInvalid',
        ABOUT_LABEL: 'aboutLabel',
        ABOUT_LICENSE_NOTICE: 'aboutLicenseNotice',
        ABOUT_COPYRIGHT_NOTICE: 'aboutCopyrightNotice',
        ABOUT_CHANGELOG: 'aboutChangelog',
        ABOUT_GITHUB: 'aboutGithub',
        ABOUT_WEBSITE: 'aboutWebsite',
        ABOUT_PRIVACY: 'aboutPrivacy',
        ABOUT_TERMS: 'aboutTerms',
